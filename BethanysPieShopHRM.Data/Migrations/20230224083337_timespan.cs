        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiftStart = table.Column<TimeSpan>(nullable: false),
                    ShiftEnd = table.Column<TimeSpan>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SwapStatusInt = table.Column<int>(nullable: false),
                    SwapStatus = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 900.0, 0.0, 1, new DateTime(2023, 2, 24, 9, 33, 36, 894, DateTimeKind.Local).AddTicks(2634), "I went to a conference", 1, 2, 0, "Conference Expense" });
